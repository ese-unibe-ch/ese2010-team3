...
public interface IQuestionDatabase {
	 ...
	 * 
	 * @param id unique identifier for a question.
	...
	/**
	 * Search the <code>Questions</code> in the DB for the term. This includes their
	...
	/**
	 * Deletes the Question without cleaning up. Does nothing if id doesn't exist.
	 * 
	 ...
	 * 
	 * @param owner author of the question
	 * @param content text of the question
	...
	/**
	 * Number of answers a, that declare themselves to be <code>a.isHighRated()</code>
	 * @return int n >= 0
	 */
	...
	/**
	 * Returns a list of similar questions. This means, that they have at least one tag in common.
	 * Further, the returned list is sorted by relevance. <br/>
	 * It is anti-reflexive, ie <br/>
	 * <code>findSimilar(q).contains(q) == false</code>,<br/>
	 * symmetric, ie <br/>
	 * <code>findSimilar(q).contains(p)</code> iff <code>findSimilar(p).contains(q)</code><br/>
	 * but not necessarily transitive.
	 * @param q reference question
